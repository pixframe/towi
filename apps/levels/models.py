...
# TOWI IMPORTS
from reusable.constants import BLANK, BLANK_NOT_NULL, REQUIRED
...
class ArbolMusical(models.Model):
    ...
    birds = models.PositiveSmallIntegerField(**BLANK)
...
class Prueba(models.Model):
    ...
    weather_object_packed = models.CharField(db_column='weatherObjectPacked', max_length=1000)
    ...
    lab_mhits = models.DecimalField(db_column='labXHits', max_digits=4, decimal_places=2, **BLANK)
    lab_mcrosses = models.DecimalField(db_column='labXCrosses', max_digits=4, decimal_places=2, **BLANK)
    lab_mdeadends = models.DecimalField(db_column='labXDeadEnds', max_digits=4, decimal_places=2, **BLANK)
    ...
    # ARRANGE MINI GAME
    arrange_amplitude = models.IntegerField(**BLANK)
    ...
    arrange_perc_correct = models.DecimalField(db_column='unPackPercTotalCorrect', max_digits=4, decimal_places=2, **BLANK)
...
class ChildrenTowiIsland(models.Model):
    ...
    def first_time_completed(self):
        if self.rio_first_time is False and self.tesoro_first_time is False and self.arbol_first_time is False and self.arena_first_time is False and self.sombras_first_time is False and self.bolita_first_time is False:
            return True
        else:
            return False

    @classmethod
    def create_towi_island(cls, parent, children):
